...
#SBATCH --output=downsampled_datasets/log.log
#SBATCH --nodes=1
...
python make_det_matricies.py --compas_file_regex "downsampled_datasets/compas_data/*.h5" --outdir downsampled_datasets/500_matricies -n 500
