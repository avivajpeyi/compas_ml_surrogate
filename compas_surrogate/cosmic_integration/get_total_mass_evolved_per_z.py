...
def three_part_broken_power_law(x, x1=0.01, x2=0.08, x3=0.5, x4=200, a1=-0.3, \
                                a2=-1.3, a3=-2.3, C1=1):
...
def invert_cdf_broken_power_law(CDF, x1, x2, x3, x4, a1, a2, a3, C1):
    ...
    CDFx2 = cdf_broken_power_law(np.array([x2, x2]), x1, x2, x3, x4, a1, a2, a3, C1)[0]
    CDFx3 = cdf_broken_power_law(np.array([x3, x3]), x1, x2, x3, x4, a1, a2, a3, C1)[0]
...
def create_sample_universe(binaryFraction=1., x1=0.01, x2=0.08, x3=0.5, x4=200, a1=-0.3, \
    ...
    CDFmin = cdf_broken_power_law(np.array([Mmin]), x1, x2, x3, x4, a1, a2, a3, C1)
    CDFmax = cdf_broken_power_law(np.array([Mmax]), x1, x2, x3, x4, a1, a2, a3, C1)
...
def get_total_mass_evolved_per_z(compas_mass_evolved_per_z, Mlower=None, Mupper=None, binaryFraction=0.7, \
                                 x1=0.01, x2=0.08, x3=0.5, x4=200., a1=-0.3, a2=-1.3, a3=-2.3, C1=1., Mmax=200):
    M1, M2 = create_sample_universe(binaryFraction=binaryFraction, x1=x1, x2=x2, x3=x3, x4=x4, \
